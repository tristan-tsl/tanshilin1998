...
- 目录
  ...
  - 7 Logappender样例
    - [7.1 log4j样例](https://github.com/apache/rocketmq/blob/master/docs/cn/RocketMQ_Example.md#71-log4j样例)
    - [7.2 log4j2样例](https://github.com/apache/rocketmq/blob/master/docs/cn/RocketMQ_Example.md#72-log4j2样例)
    - [7.3 logback样例](https://github.com/apache/rocketmq/blob/master/docs/cn/RocketMQ_Example.md#73-logback样例)
  - 8 OpenMessaging样例
    - [8.1 OMSProducer样例](https://github.com/apache/rocketmq/blob/master/docs/cn/RocketMQ_Example.md#81-omsproducer样例)
    - [8.2 OMSPullConsumer](https://github.com/apache/rocketmq/blob/master/docs/cn/RocketMQ_Example.md#82-omspullconsumer)
    - [8.3 OMSPushConsumer](https://github.com/apache/rocketmq/blob/master/docs/cn/RocketMQ_Example.md#83-omspushconsumer)
