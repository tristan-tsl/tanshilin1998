/*
 ...
 Source Server         : dev-192.168.90.235
 Source Server Type    : MySQL
 Source Server Version : 80012
 Source Host           : 192.168.90.235:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 7540 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = 'config_info' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8140 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '多租户改造' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tenant_info`  (
  ...
  INDEX `idx_tenant_id`(`tenant_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = 'tenant_info' ROW_FORMAT = DYNAMIC;
