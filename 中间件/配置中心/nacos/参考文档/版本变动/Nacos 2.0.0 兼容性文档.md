...
详情见：[Nacos2.0服务发现模块压测报告](https://nacos.io/zh-cn/docs/nacos2-naming-benchmark.html) 以及 [Nacos2.0配置模块压测报告](https://nacos.io/zh-cn/docs/nacos2-config-benchmark.html) 。
...
![nacos2_port_exposure.png](Nacos 2.0.0 兼容性文档.assets/nacos2_port_exposure.png)
