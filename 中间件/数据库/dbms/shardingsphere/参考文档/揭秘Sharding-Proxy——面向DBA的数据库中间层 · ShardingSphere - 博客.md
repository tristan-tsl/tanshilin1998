...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy1.jpg)

与其他两个产品（Sharding-JDBC、Sharding-Sidecar）的对比：

![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy2.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy3.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy4.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy5.jpg)

代码很容易理解，使用PreparedStatement执行两次查询操作，每次都把参数user_id设置为10。分析抓到的包，JDBC和MySQL之间的协议消息交互如下：

![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy6.jpg)
...
![img](hhttps://shardingsphere.apache.org/blog/img/proxy7.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy8.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy9.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy10.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy11.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy12.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy13.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy14.jpg)
...
![img](揭秘Sharding-Proxy——面向DBA的数据库中间层 · ShardingSphere - 博客.assets/proxy15.jpg)