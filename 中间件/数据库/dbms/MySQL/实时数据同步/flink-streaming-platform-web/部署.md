...
kubectl -n bigdata-sync exec -it flink-taskmanager-56cc8c749-b7z6f flink-taskmanager-c taskmanager -- bash
telnet flink-jobmanager 6123

kubectl -n bigdata-sync delete pod flink-taskmanager-56cc8c749-97fpl
kubectl -n bigdata-sync delete pod flink-taskmanager-56cc8c749-mndnj
```
...
kubectl -n bigdata-sync exec -it flink-streaming-platform-web-6964f78b87-7khdw -c flink-streaming-platform-web -- bash
```

# 访问

http://flink-bigdata-sync.local.
