...
## [架构](https://flink.apache.org/zh/flink-architecture.html)   应用    [运维](https://flink.apache.org/zh/flink-operations.html)
...
![img](Apache Flink 是什么？-应用.assets/function-state.png)
...
![img](Apache Flink 是什么？-应用.assets/api-stack.png)
