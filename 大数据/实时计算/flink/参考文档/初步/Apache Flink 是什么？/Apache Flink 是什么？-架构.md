...
## 架构    [应用](https://flink.apache.org/zh/flink-applications.html)   [运维](https://flink.apache.org/zh/flink-operations.html)
...
![img](Apache Flink 是什么？.assets/bounded-unbounded.png)
...
![img](Apache Flink 是什么？.assets/local-state.png)
