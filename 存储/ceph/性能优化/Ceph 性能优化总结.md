...
1. \1. Ceph 性能优化总结
   1. 1.1. 硬件优化
      1. [1.1.0.1. 1. 硬件规划](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#1-硬件规划)
      2. [1.1.0.2. 2. SSD 选择](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#2-SSD-选择)
      3. [1.1.0.3. 3. BIOS 设置](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#3-BIOS-设置)
2. 1.2. 软件优化
   1. [1.2.0.1. 1. Linux OS](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#1-Linux-OS)
   2. 1.2.0.2. 2. Ceph Configurations
      1. [1.2.0.2.0.1. [global\]](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#global)
      2. [1.2.0.2.0.2. [osd\] - filestore](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#osd-filestore)
      3. [1.2.0.2.0.3. [osd\] - journal](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#osd-journal)
      4. [1.2.0.2.0.4. [osd\] - osd config tuning](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#osd-osd-config-tuning)
      5. [1.2.0.2.0.5. [osd\] - recovery tuning](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#osd-recovery-tuning)
      6. [1.2.0.2.0.6. [osd\] - client tuning](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#osd-client-tuning)
3. [1.2.0.3. 3. PG Number](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#3-PG-Number)
4. [1.2.0.4. 4. CRUSH Map](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#4-CRUSH-Map)
5. [1.2.0.5. 5. 其他因素的影响](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#5-其他因素的影响)
6. [1.2.0.6. ceph.conf](https://vk.masantu.com/wiki/💻工作/存储/CEPH/Ceph运维/Ceph performance tune/#ceph-conf)
